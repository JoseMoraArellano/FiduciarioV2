...
<div x-data="cppController()" x-init="init()" class="p-6 space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-semibold text-gray-800">Gestión de Costo porcentual promedio de captación</h1>
    ...
    <div class="bg-white rounded-lg shadow p-4">
        <form method="GET" action="" class="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
            ...
            <div class="flex gap-2">
                ...
                <a href="catalogos.php?mod=cpp" class="px-4 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300"><i class="fas fa-eraser mr-1"></i> Limpiar filtros</a>
            </div>
        </form>
    </div>
