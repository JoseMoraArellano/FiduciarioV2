    ...
    try {
        switch ($action) {
            case 'update':
                ...
                // Corregir manejo de booleanos para PostgreSQL
...
<body class="bg-gray-100" x-data="{ 
                ...
                <?php if ($message): ?>
                    <div class="mb-6" x-data="{ showAlert: true }" x-show="showAlert" x-transition>
                        <div class="rounded-md p-4 <?php
                                                    echo $messageType === 'success' ? 'bg-green-50 border border-green-200' : ($messageType === 'error' ? 'bg-red-50 border border-red-200' : 'bg-blue-50 border border-blue-200');
                                                    ?>">
                            <div class="flex">
                                <div class="flex-shrink-0">
                                    <i class="<?php
                                                echo $messageType === 'success' ? 'fas fa-check-circle text-green-400' : ($messageType === 'error' ? 'fas fa-exclamation-circle text-red-400' : 'fas fa-info-circle text-blue-400');
                                                ?>"></i>
                                </div>
                                <div class="ml-3">
                                    <h3 class="text-sm font-medium">
                                        <?php echo $messageType === 'success' ? '¡Éxito!' : ($messageType === 'error' ? 'Error' : 'Información'); ?>
                                    </h3>
                ...
                <div class="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4"
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div class="text-sm text-gray-600">
                            ...
                            Total: <strong><?php echo count($variables); ?></strong>
                        </div>
                    </div>

                    <!-- Buscador -->
                    <div class="flex items-center gap-2">
                        <b > Buscar por nombre o nota: </b>
                        <div class="relative">
                        ...
                        <button
                            @click="searchTerm = ''; $nextTick(() => filterTable())"
                            x-show="searchTerm.length > 0"
                            class="px-3 py-2 text-gray-600 bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors inline-flex items-center gap-1"
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <?php else: ?>
                                    <?php foreach ($variables as $var): ?>
                                        <tr class="hover:bg-gray-50 transition-colors variable-row"
                                            data-search="<?php echo strtolower(htmlspecialchars(($var['nom'] ?? '') . ' ' . ($var['nota'] ?? ''))); ?>">
            ...
            <div class="p-6">
                ...
                <form method="POST" class="space-y-4">
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" name="visible" id="visible_edit" value="1"
                            :checked="editData.visible == 1 || editData.visible == true || editData.visible == 't'"
                            class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                        <label for="visible_edit" class="ml-2 text-sm text-gray-700">
    ...
    <script>
        ...
        function filterTable() {
            ...
            // Actualizar contador de resultados visibles (opcional)
