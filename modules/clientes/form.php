    ...
    <form method="POST" action="modules/clientes/action.php" @submit="validateForm" id="clienteForm" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div>
                        ...
                        ><?php echo htmlspecialchars(getFieldValue('coment', $cliente, [])); ?></textarea>
                    </div>
     ...
     <label class="flex items-start p-4 border-2 border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer transition">
        ...
        <div x-show="activeTab === 'documents'" class="bg-white rounded-lg shadow p-6">
            ...
            <div class="mb-6">
                <h3 class="text-lg font-semibold text-gray-800 mb-4">Cargar Documentos</h3>
                ...
                <div x-show="selectedFiles.length > 0" class="mt-4">
                    <h4 class="font-medium text-gray-800 mb-2">Archivos seleccionados:</h4>
                    <div class="space-y-2">
                        <template x-for="(file, index) in selectedFiles" :key="index">
            ...
            <?php if ($isEdit && !empty($cliente['documentos'])): ?>
            <div>
                <h3 class="text-lg font-semibold text-gray-800 mb-4">Documentos Existentes</h3>
...
function clienteFormController(isEdit, clienteId) {
    return {
        ...
        init() {
            console.log('Formulario de cliente inicializado', { isEdit, clienteId });
            this.checkCanVerify();
        },
