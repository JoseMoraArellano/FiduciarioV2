...
// Verificar permisos
$canCreate = $clientePermissions->canCreate();
$canEdit = $clientePermissions->canEdit();
$canDelete = $clientePermissions->canDelete();
$canExport = $clientePermissions->canExport();
$canVerifyQSQ = $clientePermissions->canVerifyQSQ();
$canViewDocs = $clientePermissions->canManageDocuments();
?>
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    <!-- Editar -->
                                    <a 
                                        href="catalogos.php?mod=clientes&action=edit&id=<?php echo $cliente['id']; ?>"
                                    ...
                                    <button 
                                        ...
                                        class="<?php echo $cliente['activo'] ? 'text-yellow-600 hover:text-yellow-900' : 'text-green-600 hover:text-green-900'; ?>"
